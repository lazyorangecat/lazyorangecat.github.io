    ...
    public class MemberContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            List<Member> members = new List<Member>
            {
                ...
                new Member { Id=29,Name="吳奕君",Brief="", Department = "資工系", Gender = false, City = "新竹市", FuturePlan ="stuty", Salary = "38000~40000",Team="第四組",Photo="https://raw.githubusercontent.com/Chun-2000/Chun-2000.github.io/main/MyPhoto.jpg"},
